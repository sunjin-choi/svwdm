...
cmake --build "$build_dir" --target run-tuner_search_lock_row
...
open_if_exists "${plots_dir}/tuner_search_lock_row_ring0.png"
open_if_exists "${plots_dir}/tuner_search_lock_row_ring1.png"
